...
'Heliopolis',
'M','Saturday',0,'1234567890123451','active','full_time',
'Mayan Samir','01234567896',
6,2,'09-01-2018',NULL,'HR'), 

('Mohamed','Ahmed','mohamed.ahmedy@guc.edu.eg','9087',
'Nasr City',
'F','Saturday',7,'1234567890123452','active','part_time',
...
insert into leave (date_of_request,start_date,end_date
,final_approval_status)
values ('10-05-2025','10-06-2025','10-06-2025','pending') 
...
replacement_emp)
values (61, 'proctoring','10-02-2025',8,18)
insert into Compensation_Leave (request_ID,reason, date_of_original_workday,emp_ID,
replacement_emp)
...
exec HR_approval_unpaid @request_ID, @HR_ID;
exec Upperboard_approve_unpaids @request_ID, @Upperboard_ID;





select * from Attendance where emp_ID=4

select employee_ID, annual_balance from Employee
select * from Employee_Approve_Leave e,Annual_Leave c where e.Leave_ID=c.request_ID and c.request_ID=65
select * from Leave where request_ID=65
select * from Annual_Leave where emp_ID=2
print dbo.is_on_leave(2,'12-13-2025', '12-22-2025')
select * from Employee_Replace_Employee where Emp2_ID=2
 
--CORRECTTTT :)
print dbo.HRLoginValidation(5,670);
print dbo.EmployeeLoginValidation(1,123);
select * from dbo.MyPerformance(2,'W24');
select * from dbo.MyAttendance(3);
select * from dbo.Last_month_payroll(2);
print dbo.Is_On_Leave(8,'11-13-2025','03-13-2026');
print dbo.calculatesalary(2);
print dbo.final_approval(10);
...
select * from dbo.Deductions_Attendance(1,10);
exec Create_Holiday;
exec Add_Holiday mariam,'11-13-2025','11-20-2025';
exec Initiate_Attendance;
exec Update_Attendance 4,'09:00:30', '17:00:45';
print dbo.Bonus_amount(3);
exec Deduction_days 1;
exec Deduction_hours 1;
exec Dean_andHR_Evaluation 1, 4, 'amazing', 'W25';
exec Update_Status_Doc;
select * from Status_leaves(8);
exec Replace_employee 6, 3, '9-13-2025', '11-13-2025';
exec Deduction_unpaid 4;
exec Add_Payroll 1, '10-01-2025', '10-30-2025';
exec Update_Employment_Status 2;
exec Remove_Deductions;
exec Remove_Holiday;
exec Remove_DayOff 1;
exec Remove_Approved_Leaves 2;
exec Submit_medical 21, '11-13-2025', '11-13-2025', 'maternity', 1, 'alive', 'idk', 'pregnant';
exec Submit_unpaid 21, '11-13-2025', '11-13-2025', 'rn', 'azza';
exec Submit_annual 1, 2, '12-13-2025', '12-22-2025';
exec Submit_accidental 1, '11-28-2025', '11-29-2025';
exec Submit_compensation 61, '11-24-2025', 'idk', '10-02-2025', 18;
exec HR_approval_an_acc 65, 5;
exec Upperboard_approve_annual 65, 14, 2;


--pending
--try approved example
exec HR_approval_comp 31,10;
