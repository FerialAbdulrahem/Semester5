...
{
    public partial class HR_Approve_Unpaid : System.Web.UI.Page
    {
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            ProcessApproval("HR_approval_unpaid");
            LoadUpdatedRecord();

            if (gvResult.Rows.Count == 0)
            {
                lblMessage.Text = "This Request is not an Unpaid Leave.";
            }
            else
            {
        ...
        void LoadUpdatedRecord()
        {
            ...
            WHERE L.request_ID = UL.request_ID and UL.request_ID= @id", conn))
            {
